...
#SIZE=768
#sudo echo $(($SIZE*2*1024*1024)) > /sys/block/zram0/disksize
#sudo echo $(($SIZE*1024*1024)) > /sys/block/zram1/disksize
#sudo echo "1610612736" > /sys/block/zram1/disksize
#sudo echo "805306368" > /sys/block/zram1/disksize
